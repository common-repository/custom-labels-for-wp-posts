...
echo '<h2 style="padding-left:0px">Add a Custom Label here : </h2><input type="text" id="" name="_input_meta_box" value="'.esc_attr($_metabox_input).'"placeholder="Add Custom Label"/>';

}
add_action('save_post','save_meta_box');
function save_meta_box($post_id){
if(array_key_exists('_input_meta_box', $_POST)){
update_post_meta($post_id,'_input_meta_box',sanitize_text_field($_POST['_input_meta_box']));
}
}
